...
function handleBold(event, change) {
  ...
  if (isToggleMark('*', chars, startOffset)) {
    ...
    // change.delete();
    newestChange.deleteForward(deleteRange - 1).insertText(boldChars).extend(boldChars.length).addMark('bold').collapseToEnd().removeMark('bold');
...
//# sourceMappingURL=0.398e3d89591deb23fb79.hot-update.js.map