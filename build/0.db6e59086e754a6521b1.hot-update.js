...
function handleBold(event, change) {
  ...
  if (isToggleMark('*', chars, startOffset)) {
    ...
    // change.delete();
    newestChange.move(deleteRange).deleteBackward(deleteRange).insertText(boldChars);
    // .extend(boldChars.length - 1)
    // .addMark('bold')
    // .collapseToEnd()
    // .removeMark('bold');
...
//# sourceMappingURL=0.db6e59086e754a6521b1.hot-update.js.map