...
function handleBold(event, change) {
  ...
  if (isToggleMark('*', chars, startOffset)) {
    ...
    // change.delete();
    newestChange.deleteForward(deleteRange - 2).insertText(boldChars).extend(boldChars.length).addMark('bold').collapseToEnd().removeMark('bold');
...
//# sourceMappingURL=0.aa80e4cb165e9a6870e5.hot-update.js.map