...
function handleBold(event, change) {
  ...
  if (isToggleMark('*', chars, startOffset)) {
    ...
    change.deleteForward(deleteRange).insertText(boldChars).extend(-boldChars.length).splitInline().addMark('bold').removeMark('bold');
  }
  return true;
}
...
//# sourceMappingURL=0.d582d007161df7224cb8.hot-update.js.map