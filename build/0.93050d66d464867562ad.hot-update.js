...
function handleBold(event, change) {
  ...
  if (isToggleMark('*', chars, startOffset)) {
    ...
    // change.delete();
    newestChange.deleteBackward(2 - deleteRange).insertText(boldChars).extend(boldChars.length).addMark('bold').collapseToEnd().removeMark('bold');
...
//# sourceMappingURL=0.93050d66d464867562ad.hot-update.js.map