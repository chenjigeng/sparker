...
function handleBold(event, change) {
  ...
  if (isToggleMark('*', chars, startOffset)) {
    ...
    // change.delete();
    newestChange.move(deleteRange).deleteBackward(deleteRange).insertText(boldChars).extend(boldChars.length).addMark('bold').collapseToEnd().removeMark('bold');
...
//# sourceMappingURL=0.40c642789771fdd53bd3.hot-update.js.map