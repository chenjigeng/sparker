...
function handleBold(event, change) {
  ...
  if (isToggleMark('*', chars, startOffset)) {
    ...
    // change.delete();
    newestChange.move(deleteRange).deleteBackward(deleteRange).insertText(boldChars).extend(boldChars.length);
    // .addMark('bold')
    // .collapseToEnd()
    // .removeMark('bold');
...
//# sourceMappingURL=0.d96e81e79ab5875a1d10.hot-update.js.map