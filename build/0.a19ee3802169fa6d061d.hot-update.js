...
function handleBold(event, change) {
  ...
  if (isToggleMark('*', chars, startOffset)) {
    ...
    // change.delete();
    newestChange.move(deleteRange).deleteBackward(deleteRange).insertText(boldChars).extend(boldChars.length - 1);
    // .addMark('bold')
    // .collapseToEnd()
    // .removeMark('bold');
...
//# sourceMappingURL=0.a19ee3802169fa6d061d.hot-update.js.map